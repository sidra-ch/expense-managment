...
import { BarChart3, Layers2, Package, Plus, Settings } from "lucide-react";
    ...
    return <div className="fixed left-0 top-0 bg-gray-900 text-white w-64 min-h-screen p-6 z-10">
        <div className="mb-8">
            <div className="flex items-center space-x-2 mb-4">
             ...
             <span className="text-lg font-semibold">Expenses-Managment</span>
            </div>
        </div>
        <nav className="space-y-1">
            ...
            {navigation.map((item, key) =>{
               ...
               <Link href={item.href}
                key={key}
                className={`flex items-center mb-3 px-3 space-x-3 py-2 rounded-lg ${
